package io.fydeos.kangtester.nn;
...
import io.fydeos.kangtester.nn.yolo.PostProcess;
import io.fydeos.kangtester.nn.tracker.ObjectTracker;

import java.io.IOException;
import java.util.ArrayList;

import static io.fydeos.kangtester.nn.yolo.PostProcess.INPUT_SIZE;
import static io.fydeos.kangtester.nn.rga.HALDefine.CAMERA_PREVIEW_WIDTH;
import static io.fydeos.kangtester.nn.rga.HALDefine.CAMERA_PREVIEW_HEIGHT;
...
public class InferenceResult {
    ...
    public void init(Context ctx) throws IOException {
        ...
        mPostProcess = new PostProcess(ctx);
